...
// Module-specific configuration for nexus-suite
const MODULE_NAME = "nexus-suite";
...
export function refreshSession(
  ...
  if (session) {
    ...
    console.warn(
      "[BETTER-AUTH] WARNING: Session not found in storage during refresh. Session may have been lost due to server restart or hot reload.",
    );
  }
}
