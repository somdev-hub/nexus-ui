...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[AUTH SIGNUP ADMIN] Cookie name:", SESSION_COOKIE_NAME);
    console.log("[AUTH SIGNUP ADMIN] Cookie options:", {
      httpOnly: true,
      secure: process.env.NODE_ENV === "production",
      sameSite: "lax",
      maxAge: expiresIn,
    ...
    console.log("[AUTH SIGNUP ADMIN] Refresh cookie set");
    console.log("[AUTH SIGNUP ADMIN] Refresh cookie name:", REFRESH_TOKEN_COOKIE_NAME);
