...
apiClientPublic.interceptors.request.use(requestInterceptor, requestErrorHandler);
apiClientPublic.interceptors.response.use(responseInterceptor, responseErrorHandler);
