...
import { Code2, Columns2, ExternalLink, Eye, Moon, Sun } from "lucide-react";
...
function EditorPane({
	...
	return (
        ...
        .editor-scroll.scrolling::-webkit-scrollbar-thumb {
        ...
        .editor-scroll:hover,
        .editor-scroll.scrolling {
          scrollbar-color: ${theme === "dark" ? "rgba(255,255,255,0.18)" : "rgba(0,0,0,0.18)"} transparent;
        }
      `}</style>
		</div>
	);
