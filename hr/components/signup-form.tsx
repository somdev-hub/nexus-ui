...
export function SignupForm({
  ...
  const isOrgFormValid = organization.orgName && organization.orgType;
            ...
            <form className="p-6 md:p-8">
              <FieldGroup>
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="text-muted-foreground text-balance">
                    Please provide information about your organization to
                ...
                <Field>
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      setOrganization((prev) => ({ ...prev, orgType: value }))
                    }
                  >
                ...
                <Field className="flex gap-3 mt-2">
                  <Button type="submit" disabled={!isOrgFormValid}>
                    Complete Signup
                  </Button>
                  <Button
                    type="button"
            ...
            <form className="p-6 md:p-8">
              <FieldGroup>
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="text-muted-foreground text-balance">
                    Sign up to get started with Nexus Inc
                  </p>
                </div>
                <Field>
